...
<body class="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 overflow-y-auto">
  ...
  <!-- Footer -->
  <footer class="py-4 text-center text-xs text-slate-500 w-full">
